...
class MainWindow(tk.Tk):
    ...
    def _create_widgets(self):
        ...
        ttk.Button(
            self, text="Browse", command=self._browse_project
        ).pack(pady=5)
        ...
        ttk.Button(btn_frame, text="Build APK", command=self._start_build) \
            .pack(side=tk.LEFT, padx=5)
        ttk.Button(btn_frame, text="Exit", command=self.destroy) \
